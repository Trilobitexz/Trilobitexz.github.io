...
// Replace lines 1316 to 1447 with newLines.
lines.splice(1316, 1448 - 1316 + 1, newLines);

// Also we need to append the app.post("/api/stocks/ai-chain") before startServer.
// So let's insert it right after the generateSimulatedComparison / or near the end.

const finalContent = lines.join('\n');
fs.writeFileSync('server.ts', finalContent);
console.log('Restored corrupted block.');
