...
// The file currently has an old app.post("/api/stocks/ai-chain"...
// It starts at "// --- AI Industry Chain Analyzer ---"
// and ends right before "// --- MAIN ROUTE SERVER SETUP & VITE MIDDLEWARE ---"

const regex = /\/\/ --- AI Industry Chain Analyzer ---[\s\S]*?\/\/ --- MAIN ROUTE SERVER SETUP & VITE MIDDLEWARE ---/;

const endpointCode = `// --- AI Industry Chain Analyzer ---
...
file = file.replace(regex, endpointCode);

fs.writeFileSync('server.ts', file);
console.log('Replaced endpoint correctly');
